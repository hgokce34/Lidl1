...
public class RegisteringAs_A_User {
    public static void main(String[] args) {
        ...
        WebElement joinButton = driver.findElement(By.xpath("(//a[@class='clickable link clickable--theme-primary clickable--size-auto clickable--color-blue clickable--bold-weight'])[1]"));
        joinButton.click();
